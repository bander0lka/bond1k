...
function clearCheckedInput ()
{
    ...
    document.getElementById("order__phoneNumber3").value = "";
    ...
    document.getElementById("drugoe").value = "";
    ...
    inputs = document.getElementsByName("Pit");
    ...
    inputs = document.getElementsByName("Otd");
